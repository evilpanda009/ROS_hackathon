...
class GotoPoint:
    def __init__(self):
        ...
        while distance > 0.03:
            ...
            #move_cmd.linear.y = min(control_signal_distance,0.25)
...
while(pp.check(endpos, obstacles)):
    endpos = pp.inp()'''
